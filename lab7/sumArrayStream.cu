...
int main(int argc, char **argv) {
  ...
  // hostRef will contains the summed vector made by the CPU to check the result with the GPU sum
...
> Device IS capable of simultaneous CPU-to-GPU datatransfers
> Compute Capability 8.6 hardware with 82 multi-processors
> with streams = 4
> vector size = 262144
> grid (2048, 1) block (128, 1)

Measured timings (throughput):
 Memcpy host to device  : 0.291008 ms (3.603255 GB/s)
 Memcpy device to host  : 0.124960 ms (8.391293 GB/s)
 Kernel                 : 0.035136 ms (59.686704 GB/s)
 Total                  : 0.451104 ms (4.648933 GB/s)

Actual results from overlapped data transfers:
 overlap with 4 streams : 0.287776 ms (7.287446 GB/s)
 speedup                : 36.206287 
Arrays match.
*/